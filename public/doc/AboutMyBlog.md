...
解决方案：1.点击消失  ==> 准备就用jquery的show(),和hide()  ,  就弄简单点。
...
3. 列表动态跳转问题，列表跳转和分类列表跳转冲突问题（node.js）,
 ...
 4.将时间类型数据保存到mongodb数据库中，拿出来时发现时间变成  类似于：2019-03-15T08:44:07.842Z --- 这种UTC时间，这是mongodb数据库本身就存在的问题，自己遇到这个问题的时候，百度了很多文档，参考了很多人的解决办法，但还是不知道怎么解决，
